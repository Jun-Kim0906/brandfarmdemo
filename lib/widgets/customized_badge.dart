...
class CustomizedBadge extends StatefulWidget {
  ...
  @override
  CustomizedBadgeState createState() {
    return CustomizedBadgeState();
  }
}

class CustomizedBadgeState extends State<CustomizedBadge> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CustomizedBadge oldWidget) {
